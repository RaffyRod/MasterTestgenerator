export const messages = {
  en: {
    ...
    testPlan: {
      ...
      subtitle:
        "Generate comprehensive test plans from project information or acceptance criteria",
      projectInfo: "Project Information / Acceptance Criteria",
      projectInfoPlaceholder:
        "Enter project description, requirements, or acceptance criteria...",
      ...
      selectTypeDescription:
        "Choose the type of test plan you want to generate:",
    ...
    testCase: {
      ...
      noTestCases:
        "No test cases generated yet. Enter project information and click Generate.",
    ...
    export: {
      ...
      rows: "Rows",
      previewNote:
        "This is how your test cases will appear in the selected tool",
    ...
    notifications: {
      ...
      aiNotAvailable:
        "AI service is not available. Using intelligent analyzer instead.",
      ...
      aiConfigRequired:
        "Please configure API key in AI Settings for this provider",
    },
    aiConfig: {
      title: "AI Configuration",
      subtitle:
        "Configure your AI provider and API keys for enhanced test generation",
      ...
      customEndpointHint:
        "Enter the base URL for your custom AI provider (e.g., https://api.example.com)",
    ...
    bugReport: {
      ...
      subtitle:
        "Create detailed bug reports with evidence and export them to Jira or other tools",
      ...
      selectTitle: "Select Bug Title",
      selectTitleHint: "Choose the best title for your bug report:",
      priority: "Priority",
      ...
      descriptionHint:
        "Describe what happened, when it occurred, and any relevant context. AI will generate steps to reproduce automatically.",
      ...
      uploadHint:
        "Supports images, text files, logs (PNG, JPG, TXT, LOG, JSON)",
      remove: "Remove",
  ...
  es: {
    ...
    testPlan: {
      ...
      selectTypeDescription:
        "Elige el tipo de plan de prueba que deseas generar:",
      ...
      planTypes: {
        ...
        regression: {
          ...
          description:
            "Pruebas para asegurar que la funcionalidad existente aún funciona",
        },
        comprehensive: {
          name: "Plan de Prueba Integral",
          description:
            "Plan de prueba completo que cubre todos los tipos de prueba",
        },
        shiftLeft: {
          name: "Plan de Prueba Shift-Left",
          description:
            "Pruebas tempranas en SDLC, TDD, pruebas unitarias e de integración",
        },
        shiftRight: {
          name: "Plan de Prueba Shift-Right",
          description:
            "Pruebas en producción, monitoreo y retroalimentación del usuario",
        },
        continuous: {
          name: "Plan de Prueba Continua",
          description:
            "Pruebas integradas en CI/CD con pipelines automatizados",
        },
        tdd: {
        ...
        devops: {
          ...
          description:
            "Pruebas en pipeline DevOps con enfoque en automatización",
        },
      },
    },
    testCase: {
    ...
    export: {
      ...
      rows: "Filas",
      previewNote:
        "Así es como aparecerán tus casos de prueba en la herramienta seleccionada",
    ...
    notifications: {
      ...
      testCasesError:
        "Error al generar casos de prueba. Por favor, inténtalo de nuevo.",
      testPlanGenerated: "Plan de prueba generado exitosamente",
      testPlanError:
        "Error al generar plan de prueba. Por favor, inténtalo de nuevo.",
      ...
      aiError:
        "La generación con IA falló. Usando analizador inteligente en su lugar.",
      invalidInput:
        "Por favor, ingresa información del proyecto o criterios de aceptación",
      noTestCases:
        "No se generaron casos de prueba. Por favor, verifica tu entrada.",
      noTestPlan:
        "No se generó plan de prueba. Por favor, verifica tu entrada.",
      testCaseCopied: "Caso de prueba copiado al portapapeles",
      copyError:
        "Error al copiar caso de prueba. Por favor, inténtalo de nuevo.",
      aiConfigRequired:
        "Por favor, configura la clave API en Configuración de IA para este proveedor",
    },
    aiConfig: {
      title: "Configuración de IA",
      subtitle:
        "Configura tu proveedor de IA y claves API para una generación mejorada de pruebas",
      ...
      customEndpointHint:
        "Ingresa la URL base de tu proveedor de IA personalizado (ej: https://api.ejemplo.com)",
      ollamaUrl: "URL de Ollama",
      ollamaUrlHint:
        "Ingresa la URL donde Ollama está ejecutándose (por defecto: http://localhost:11434)",
    ...
    bugReport: {
      ...
      subtitle:
        "Crea reportes de bugs detallados con evidencias y expórtalos a Jira u otras herramientas",
      titleLabel: "Título del Bug",
      titlePlaceholder: "Ingresa un título conciso que describa el bug",
      titleAutoPlaceholder:
        "El título se generará automáticamente desde la descripción",
      generatingTitle: "Generando título con IA...",
      titleAutoGenerated: "Título generado automáticamente con IA",
      titleHint:
        "Comienza a escribir la descripción del bug para generar el título automáticamente",
      titleGenerating: "Generando título...",
      editTitle: "Editar título manualmente",
      selectTitle: "Seleccionar Título del Bug",
      selectTitleHint: "Elige el mejor título para tu reporte de bug:",
      priority: "Prioridad",
      ...
      descriptionHint:
        "Describe qué pasó, cuándo ocurrió y cualquier contexto relevante. La IA generará los pasos para reproducir automáticamente.",
      ...
      uploadHint:
        "Soporta imágenes, archivos de texto, logs (PNG, JPG, TXT, LOG, JSON)",
      remove: "Eliminar",
